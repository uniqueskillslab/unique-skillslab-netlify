...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-primary-500 via-primary-600 to-accent-600 text-white pt-20 pb-16 safe-area-top">
        ...
        <div className="container-custom relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="body-text mb-10 text-primary-200">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center touch-spacing">
              <Link href="/courses" className="btn-secondary text-lg px-8 py-4 touch-target">
                Enroll Now
              </Link>
              <Link href="/scholarship" className="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-4 px-8 rounded-lg transition-colors duration-200 text-lg shadow-lg hover:shadow-xl touch-target">
                🎓 Free Courses
              </Link>
              <Link href="/about" className="btn-outline text-lg px-8 py-4 border-white text-white hover:bg-white hover:text-primary-600 touch-target">
                Learn More
              </Link>
            </div>
          </div>
              ...
              <div key={course.id} className="card group hover:scale-105 transition-transform duration-300">
                ...
                <div className="space-y-3 touch-spacing">
                  <button 
                    ...
                    className="btn-primary w-full flex items-center justify-center space-x-2 touch-target"
                  >
